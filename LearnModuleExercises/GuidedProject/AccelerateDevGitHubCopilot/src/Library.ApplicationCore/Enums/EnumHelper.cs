...
public static class EnumHelper
{
    ...
    public static string GetDescription(Enum value)
    {
        ...
        switch (value)
        {
            case MembershipRenewalStatus m when MembershipRenewalStatusDescriptions.TryGetValue(m, out var md):
                return md;
            case LoanReturnStatus r when LoanReturnStatusDescriptions.TryGetValue(r, out var rd):
                return rd;
            case LoanExtensionStatus e when LoanExtensionStatusDescriptions.TryGetValue(e, out var ed):
                return ed;
            default:
